...
export function SelectCalendarAddCard({
  ...
  return (
    <Card
      className={cn(
        "relative min-w-40 flex-shrink-0 overflow-hidden rounded-lg border bg-muted/50 p-0 transition-colors hover:border-primary/50",
        className,
      )}
    >
      <button
