    ...
    return (
      <div
        ...
        className={cn(
          ...
          isCompact &&
            "border border-white/10 bg-white/[0.08] px-1 py-px text-[0.5625rem] leading-tight text-white shadow-sm",
          isSpan &&
            "border-y border-white/10 bg-white/[0.08] px-1 py-px text-[0.5625rem] leading-tight text-white shadow-sm",
